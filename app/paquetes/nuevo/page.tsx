      ...
      <div style={{maxWidth: '700px', margin: '40px auto', padding: '0 40px'}}>
        ...
        <div style={{backgroundColor: '#ffffff', borderRadius: '16px', padding: '36px', display: 'flex', flexDirection: 'column', gap: '24px'}}>
          <div>
            ...
            <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Nombre del paquete" style={inputStyle} />
          </div>
          <div>
            ...
            <textarea value={description} onChange={(e) => setDescription(e.target.value)} rows={3} style={{...inputStyle, resize: 'none', fontFamily: 'Inter, sans-serif'}} />
          </div>
          <div>
            ...
            <textarea value={includes} onChange={(e) => setIncludes(e.target.value)} rows={3} style={{...inputStyle, resize: 'none', fontFamily: 'Inter, sans-serif'}} />
          </div>
          <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px'}}>
            <div>
              ...
              <input type="number" value={price} onChange={(e) => setPrice(e.target.value)} placeholder="2500" style={inputStyle} />
            </div>
            <div>
              ...
              <input type="text" value={duration} onChange={(e) => setDuration(e.target.value)} placeholder="3 dias / 2 noches" style={inputStyle} />
            </div>
          </div>
          <div>
            ...
            <input type="number" value={maxPeople} onChange={(e) => setMaxPeople(e.target.value)} placeholder="12" style={inputStyle} />
          </div>
          <div>
